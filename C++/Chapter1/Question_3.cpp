...
void URLify(std::string &text, int size) {
    /// First count the number of spaces in the text, using the true size as the limit.
...
TEST(Question_3, NoSpacesReplace) {
