...
TEST(Question_2_1, DuplicatesInLinkedList)
{
    ...
    linkedList.AddNodeAtStart(5); linkedList.AddNodeAtStart(5);
    linkedList.AddNodeAtStart(4); linkedList.AddNodeAtStart(4);
    linkedList.AddNodeAtStart(3); linkedList.AddNodeAtStart(3);
    linkedList.AddNodeAtStart(2); linkedList.AddNodeAtStart(2);
    linkedList.AddNodeAtStart(1); linkedList.AddNodeAtStart(1);
