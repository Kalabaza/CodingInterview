...
bool HasUniqueChars(const std::string &text) {
    ...
    // enough to tell if there are any repeated chars in the input string. An array of booleans will be used and it
    // will be initialized to false in all the positions.
    ...
    // was already marked it means that a duplicated character was found, access the chars by reference to avoid
    // copying them.
